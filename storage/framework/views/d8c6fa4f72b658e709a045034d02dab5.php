...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            ...
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Selamat Datang Nama Siswa...</h4>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
...
<?php echo $__env->make('siswa.layouts.app', ['title' => 'Dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-rapor\resources\views/siswa/dashboard.blade.php ENDPATH**/ ?>