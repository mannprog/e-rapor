...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('admin.pages.sistem.jurusan.component.addOrEdit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('sistem.jurusan.store')); ?>",
                    contentType: false,
                    processData: false,
                    type: "POST",
            ...
            $('body').on('click', '#editData', function() {
                ...
                $.get("<?php echo e(route('sistem.jurusan.index')); ?>" + '/' + item_id + '/edit', function(data) {
                    $('#modal-ed').modal('show');
                    setTimeout(function() {
                        $('#nama').focus();
                    }, 500);
            ...
            $('#editBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('sistem.jurusan.index')); ?>" + '/' + item_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "<?php echo e(route('sistem.jurusan.index')); ?>" + '/' + jurusan_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Kelola Jurusan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-rapor\resources\views/admin/pages/sistem/jurusan/index.blade.php ENDPATH**/ ?>