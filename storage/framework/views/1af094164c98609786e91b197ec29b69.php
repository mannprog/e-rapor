...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('admin.pages.users.gtk.component.addOrEdit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('kelola.gtk.store')); ?>",
                    contentType: false,
                    processData: false,
                    type: "POST",
            ...
            $('body').on('click', '#editData', function() {
                ...
                $.get("<?php echo e(route('kelola.gtk.index')); ?>" + '/' + item_id + '/edit', function(data) {
                    $('#modal-ed').modal('show');
                    setTimeout(function() {
                        $('#name').focus();
                    }, 500);
            ...
            $('#editBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('kelola.gtk.index')); ?>" + '/' + item_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "<?php echo e(route('kelola.gtk.index')); ?>" + '/' + gtk_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Kelola GTK'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-rapor\resources\views/admin/pages/users/gtk/index.blade.php ENDPATH**/ ?>