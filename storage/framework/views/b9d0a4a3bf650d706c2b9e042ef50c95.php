...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('admin.pages.sistem.tajaran.component.addOrEdit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('sistem.tahunajaran.store')); ?>",
                    contentType: false,
                    processData: false,
                    type: "POST",
            ...
            $('body').on('click', '#editData', function() {
                ...
                $.get("<?php echo e(route('sistem.tahunajaran.index')); ?>" + '/' + item_id + '/edit', function(data) {
                    $('#modal-ed').modal('show');
                    setTimeout(function() {
                        $('#nama').focus();
                    }, 500);
            ...
            $('#editBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('sistem.tahunajaran.index')); ?>" + '/' + item_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Kelola Tahun Ajaran'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-rapor\resources\views/admin/pages/sistem/tajaran/index.blade.php ENDPATH**/ ?>