    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Kelola Nilai</h4>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Kelola Nilai'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-rapor\resources\views/admin/pages/nilai/index.blade.php ENDPATH**/ ?>