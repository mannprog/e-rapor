...
<?php $__env->startSection('content'); ?>
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Kelola Kelas</h4>
            </div>
        </div>
    </div>
    ...
    <?php echo $__env->make('admin.pages.sistem.kelas.component.addOrEdit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('sistem.kelas.store')); ?>",
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
                        $('#itemForm').trigger("reset");
                        $('#modal-md').modal('hide');
                        $('#kelolakelas-table').DataTable().draw();
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: data.message,
            ...
            $('body').on('click', '#editData', function() {
                ...
                $.get("<?php echo e(route('sistem.kelas.index')); ?>" + '/' + item_id + '/edit', function(data) {
                    $('#modal-ed').modal('show');
                    setTimeout(function() {
                        $('#nama').focus();
                    }, 500);
            ...
            $('#editBtn').click(function(e) {
                ...
                $.ajax({
                    data: formData,
                    url: "<?php echo e(route('sistem.kelas.index')); ?>" + '/' + item_id,
                    contentType: false,
                    processData: false,
                    type: "POST",
                    success: function(data) {
            ...
            $('body').on('click', '.deleteBtn', function(e) {
                ...
                if (confirmation) {
                    ...
                    $.ajax({
                        data: formData,
                        url: "<?php echo e(route('sistem.kelas.index')); ?>" + '/' + kelas_id,
                        contentType: false,
                        processData: false,
                        type: "POST",
                        success: function(data) {
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Kelola Kelas'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\e-rapor\resources\views/admin/pages/sistem/kelas/index.blade.php ENDPATH**/ ?>