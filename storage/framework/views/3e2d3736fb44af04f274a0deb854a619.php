<form id="deleteDoc" method="post">
    ...
    <a href="<?php echo e(route('kelola.siswa.show', $row->id)); ?>" class="btn btn-sm mb-0 btn-info"><i class="fas fa-eye"></i></a>
...
<?php /**PATH C:\laragon\www\e-rapor\resources\views/admin/pages/users/siswa/component/action.blade.php ENDPATH**/ ?>