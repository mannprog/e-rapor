...
class KelolaNilaiDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($row) {
            return view('admin.pages.nilai.component.action', compact('row'))->render();
        })
        ->rawColumns(['action']);
    }
    ...
    {
        return 'KelolaNilai_' . date('YmdHis');
    }
}
