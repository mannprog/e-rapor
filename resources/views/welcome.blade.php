...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block bg-dark"
            style="margin: 0; padding: 0; justify-content: center; align-items: center; height: 100vh; background-image: url('{{ asset('assets/images/background/bg.jpg') }}'); background-repeat: no-repeat; background-size: 100% 100%; background-position: center;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="text-center pt-3 pb-3">
                        <span class="db"><img src="{{ asset('assets/images/logo.png') }}" alt="logo"
                    ...
                    @endif
                    <!-- Form -->
                    <form class="form-horizontal mt-3" id="loginform" action="{{ route('prosesLogin') }}"
                        method="POST">
                        @csrf
                        <div class="row pb-4">
                            <div class="col-12">
